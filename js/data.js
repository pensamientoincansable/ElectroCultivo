...
const regions = {
    ...
    larioja: {
        ...
        // Small region - Keep pos, small size
        center: { x: 450, y: 165 },
        small: true
    },
    murcia: {
    ...
    paisvasco: {
        ...
        // North coast - Keep pos, small size
        center: { x: 450, y: 110 },
        small: true
    },
    cantabria: {
    ...
    asturias: {
        ...
        // North coast - Moved up slightly, small size
        center: { x: 280, y: 100 },
        small: true
    },
    galicia: {
    ...
    madrid: {
        ...
        // Center - Moved up to CyL's original position (Y=240), small size
        center: { x: 360, y: 240 },
        small: true
    },
    andalucia: {
...
const tools = {
    ...
    tractor: { name: 'Tractor Rápido', emoji: '🚜', price: 3000, effect: '-20% tiempo crecimiento' },
    tractorArado: { name: 'Tractor de Arado', emoji: '🚜', price: 5000, effect: 'Permite "Arar Todo" (10⚡)' },
