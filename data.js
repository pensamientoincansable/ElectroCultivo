...
const regions = {
    castillalamancha: {
        ...
        // Central region
        path: "330,350 450,320 500,340 540,400 500,480 380,480 320,440 310,380",
        center: { x: 420, y: 410 }
    },
    aragon: {
        ...
        path: "480,150 550,130 620,150 640,220 620,300 540,320 500,280",
        center: { x: 550, y: 220 }
    },
    extremadura: {
        ...
        path: "180,320 250,300 310,380 300,440 240,480 160,460 140,400",
        center: { x: 230, y: 400 }
    },
    larioja: {
        ...
        path: "420,150 470,145 490,170 440,180",
        center: { x: 450, y: 165 }
    },
    murcia: {
        ...
        // Southeast coast
        path: "540,460 600,470 610,510 550,520 530,490",
        center: { x: 570, y: 490 }
    },
    valencia: {
        ...
        // East coast
        path: "540,320 620,300 660,360 640,440 600,470 540,460 540,400",
        center: { x: 600, y: 380 }
    },
    cataluna: {
        ...
        // Northeast corner
        path: "620,150 720,130 760,200 720,280 640,280 640,220",
        center: { x: 690, y: 210 }
    },
    castillayleon: {
        ...
        path: "180,180 300,140 400,140 420,180 450,220 450,280 380,320 330,350 250,300 180,320 150,250",
        center: { x: 300, y: 240 }
    },
    navarra: {
        ...
        path: "480,90 540,80 550,130 480,150",
        center: { x: 510, y: 110 }
    },
    paisvasco: {
        ...
        // North coast
        path: "420,90 480,90 480,130 420,130",
        center: { x: 450, y: 110 }
    },
    cantabria: {
        ...
        // North coast
        path: "340,90 420,90 420,130 350,130",
        center: { x: 380, y: 110 }
    },
    asturias: {
        ...
        // North coast
        path: "220,100 340,90 350,130 250,140",
        center: { x: 280, y: 120 }
    },
    galicia: {
        ...
        // Northwest corner
        path: "100,120 220,100 250,140 180,180 150,220 100,180",
        center: { x: 160, y: 160 }
    },
    madrid: {
        ...
        // Center
        path: "360,300 420,280 440,320 400,350 360,330",
        center: { x: 400, y: 315 }
    },
    andalucia: {
        ...
        // South
        path: "140,400 160,460 240,480 300,440 380,480 500,480 540,520 450,580 250,560 120,480",
        center: { x: 330, y: 510 }
    }
};
